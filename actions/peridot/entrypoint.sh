...
pacman -S --noconfirm curl wget git make zip tar binutils gcc flex bison bc inetutils diffutils python3 libxml2-legacy cpio pahole libp11 opensc > /dev/null 2>&1
